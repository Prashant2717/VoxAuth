...
/// 3. eyegaze position,
/// 4. which cube selected,
/// 5. cube selection order,
/// 6. time to input password,
/// 7. error rate (correct cubes),
/// 8. button pressed,
/// 9. participant,
/// 10. timestamp
/// </summary>
...
public class CSVWriter : MonoBehaviour {
    ...
    private void CreateXML(CreateXMLEvent e)
    {
        ...
        // directory = Application.persistentDataPath + "/Test" + "/log";
        directory = "Test" + "/log";
        ...
        if (!e.specificName) {
            ...
            wrapperName = directory + "/wrapper_" + e.participantName + "_" + baseName + ".xml";
            logFilePath = directory + "/log_" + e.participantName + "_" + baseName + ".xml";
        }
    ...
    private void SaveStroke(SaveStrokeEvent e) {  
        ...
        //
        // string pathInsideAssets = "Assets/LOGs/study" + "/" + e.participantName.ToString() + "/" + e.experimentVariables[0] + "/" + e.experimentVariables[1];
        //
